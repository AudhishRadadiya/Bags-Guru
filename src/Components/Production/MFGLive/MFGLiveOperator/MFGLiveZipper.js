...
// import { setSuggestedRollList } from 'Store/Reducers/Production/mfgLiveSlice';
...
export default function MFGLiveZipper() {
  ...
  const { mfgLiveZipperPrint } = allCommon?.mfgLiveFlexo;
            ...
            dispatch(
              setAllCommon({
                ...
                mfgLiveFlexo: {
                  ...
                  mfgLiveZipperPrint: {
                    ...allCommon?.mfgLiveFlexo?.mfgLiveZipperPrint,
  ...
  const loadRequiredData = useCallback(() => {
    ...
    dispatch(
      getListFilter({
        module_name: 'mfg_operator_zipper',
      }),
    );
  ...
  const handleRemoveFilter = useCallback(
    index => {
          ...
          mfgLiveFlexo: {
            ...
            mfgListZipperParam: {
              ...
              ...(updatedFilters?.length === 0 &&
                Object.keys(
                  allFilters.mfgLiveFlexo?.mfgListZipperParam?.applied,
                )?.length !== 0 && {
                  applied: {},
                }),
              filters: [...updatedFilters],
      ...
      if (
        updatedFilters?.length === 0 &&
        Object.keys(allFilters.mfgLiveFlexo?.mfgListZipperParam?.applied)
          ?.length > 0
      ) {
        dispatch(
          MFGfProcessLists({
      ...
      setAllFilters({
        ...
        mfgLiveFlexo: {
          ...
          mfgListZipperParam: {
            ...mfgListZipperParam,
            filters: [
              ...allFilters?.mfgLiveFlexo?.mfgListZipperParam?.filters,
              { filter: '', value: '' },
            ],
          },
        },
      ...
      <div className="flexo_printing_wrap mb-3">
        <div className="table_main_Wrapper bg-white">
          <CommonHeader
            ...
            searchInnerSateName="mfgListZipperParam"
            op={op}
            dates={dates}
            ...
            mfgListParam={mfgListZipperParam}
            applied={applied}
          ...
          <div className="data_table_wrapper with_colspan_head cell_padding_small is_filter break_header">
            ...
            <DataTable
              ...
              filters={mfgLiveZipperPrintFilter}
              onFilter={event => {
                dispatch(
                  setAllCommon({
                    ...allCommon,
                    mfgLiveFlexo: {
                      ...
                      mfgLiveZipperPrint: {
                        ...allCommon?.mfgLiveFlexo.mfgLiveZipperPrint,
                        mfgLiveZipperPrintFilter: event?.filters,
                      },
                    },
                  }),
                );
                  ...
                  <div className="table_main_Wrapper bg-white">
                    ...
                    <div className="data_table_wrapper cell_padding_large is_filter custom_suggested_mfg">
                      ...
                      <DataTable
                        ...
                        filters={mfgLiveZipperRollConsumptionFilter}
                        onFilter={event => {
                          dispatch(
                            setAllCommon({
                              ...allCommon,
