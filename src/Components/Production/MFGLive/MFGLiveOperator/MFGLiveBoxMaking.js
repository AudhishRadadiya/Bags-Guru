...
export default function MFGLiveBoxMaking() {
  ...
  const { activeTabName, mfgListParam, print_technology, machine, print } =
    allFilters?.mfgLiveFlexo;
  const { mfgLiveBoxMaking } = allCommon?.mfgLiveFlexo;
  const {
  ...
  const onPageRowsChange = useCallback(
    ...
    [allFilters, dispatch, machine, mfgListParam, print, print_technology],
  );
      ...
      <div className="mt-2 d-flex justify-content-end">
            ...
            dispatch(
              setAllCommon({
                ...
                mfgLiveFlexo: {
                  ...
                  mfgLiveBoxMaking: {
                    ...allCommon?.mfgLiveFlexo?.mfgLiveBoxMaking,
        ...
        <Button
          ...
          onClick={async e => {
            ...
            let res = await dispatch(addBagDetailForPrinting(newObj));
            if (res) {
              dispatch(setViewProductDetailData({}));
              setPrintingTableModal(false);
              setPrintingData({
  ...
  const handleRemoveFilter = useCallback(
    index => {
          ...
          mfgLiveFlexo: {
            ...
            mfgListParam: {
              ...
              ...(updatedFilters?.length === 0 &&
                Object.keys(allFilters.mfgLiveFlexo?.mfgListParam?.applied)
                  ?.length > 0 && {
                  applied: {},
                }),
              filters: [...updatedFilters],
              selectedItemIndex:
                updatedFilters?.length === 0 &&
                allFilters.mfgLiveFlexo.mfgListParam.selectedItemIndex !== ''
                  ? ''
                  : allFilters.mfgLiveFlexo.mfgListParam.selectedItemIndex,
            },
          },
      ...
      if (
        updatedFilters?.length === 0 &&
        Object.keys(allFilters.mfgLiveFlexo?.mfgListParam?.applied)?.length > 0
      ) {
        dispatch(
          MFGfProcessLists({
            ...mfgListParam,
      ...
      setAllFilters({
        ...
        mfgLiveFlexo: {
          ...
          mfgListParam: {
            ...mfgListParam,
            filters: [
              ...allFilters?.mfgLiveFlexo?.mfgListParam?.filters,
              { filter: '', value: '' },
            ],
          },
        },
      ...
      <div className="flexo_printing_wrap mb-3">
        <div className="table_main_Wrapper bg-white">
          <CommonHeader
            ...
            searchInnerSateName="mfgListParam"
            op={op}
            dates={dates}
          ...
          <div className="data_table_wrapper with_colspan_head cell_padding_small is_filter break_header">
            ...
            <DataTable
              ...
              filters={mfgLiveBoxMakingFilter}
              onFilter={event => {
                dispatch(
                  setAllCommon({
                    ...allCommon,
                    mfgLiveFlexo: {
                      ...
                      mfgLiveBoxMaking: {
                        ...allCommon?.mfgLiveFlexo.mfgLiveBoxMaking,
                        mfgLiveBoxMakingFilter: event?.filters,
                      },
                    },
                  }),
                );
                  ...
                  <div className="table_main_Wrapper bg-white mb-3">
                    ...
                    <div className="data_table_wrapper cell_padding_large is_filter custom_suggested_mfg">
                      ...
                      <DataTable
                        ...
                        filters={mfgLiveBoxMakingConsumptionFilter}
                        onFilter={event => {
                          dispatch(
                            setAllCommon({
                              ...allCommon,
                      ...
                      dispatch(
                        setAllCommon({
                          ...
                          mfgLiveFlexo: {
                            ...
                            mfgLiveBoxMaking: {
                              ...allCommon?.mfgLiveFlexo.mfgLiveBoxMaking,
                              mfgLiveBoxMakingConsumptionFilter: event?.filters,
                            },
                          },
                        }),
                      );
