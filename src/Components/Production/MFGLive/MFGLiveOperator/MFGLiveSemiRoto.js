...
function MFGLiveSemiRoto(props) {
  ...
  const { mfgLiveLoading } = useSelector(({ mfgLive }) => mfgLive);
  ...
  const { mfgListSemiRotoParam, print_technology, machine, print } =
    allFilters?.mfgLiveFlexo;
  const { mfgLiveSemiROTOPrint } = allCommon?.mfgLiveFlexo;
  const {
  ...
  const loadRequiredData = useCallback(() => {
    ...
    dispatch(
      getListFilter({
        module_name: 'mfg_operator_semiroto',
      }),
    );
            ...
            dispatch(
              setAllCommon({
                ...
                mfgLiveFlexo: {
                  ...
                  mfgLiveSemiROTOPrint: {
                    ...allCommon?.mfgLiveFlexo.mfgLiveSemiROTOPrint,
  ...
  const handleRemoveFilter = useCallback(
    index => {
          ...
          mfgLiveFlexo: {
            ...
            mfgListSemiRotoParam: {
              ...
              ...(updatedFilters?.length === 0 &&
                Object.keys(
                  allFilters.mfgLiveFlexo?.mfgListSemiRotoParam?.applied,
                )?.length !== 0 && {
                  applied: {},
                }),
              filters: [...updatedFilters],
      ...
      if (
        updatedFilters?.length === 0 &&
        Object.keys(allFilters.mfgLiveFlexo?.mfgListSemiRotoParam?.applied)
          ?.length > 0
      ) {
        dispatch(
          MFGfProcessLists({
      ...
      setAllFilters({
        ...
        mfgLiveFlexo: {
          ...
          mfgListSemiRotoParam: {
            ...mfgListSemiRotoParam,
            filters: [
              ...allFilters?.mfgLiveFlexo?.mfgListSemiRotoParam?.filters,
              { filter: '', value: '' },
            ],
          },
        },
  ...
  }, [filters, dispatch, allFilters, mfgListSemiRotoParam, searchQuery]);
      ...
      if (Object.keys(applied)?.length > 0) {
        ...
        dispatch(
          MFGfProcessLists({
            ...
            ...(!Object.keys(applied)?.length && { currentPage: 1 }),
            print_technology: print_technology,
            print: print,
            machine: machine,
          }),
      ...
      <div className="flexo_printing_wrap screen_printing mb-3">
        ...
        <div className="table_main_Wrapper bg-white">
          <CommonHeader
            ...
            searchInnerSateName="mfgListSemiRotoParam"
            op={op}
            dates={dates}
            ...
            mfgListParam={mfgListSemiRotoParam}
            applied={applied}
          />
          ...
          <div className="data_table_wrapper with_colspan_head cell_padding_small is_filter break_header">
            ...
            <DataTable
              ...
              ref={tableRef}
              filters={mfgLiveSemiROTOPrintFilter}
              onFilter={event => {
                dispatch(
                  setAllCommon({
                    ...allCommon,
                    mfgLiveFlexo: {
                      ...
                      mfgLiveSemiROTOPrint: {
                        ...allCommon?.mfgLiveFlexo.mfgLiveSemiROTOPrint,
                        mfgLiveSemiROTOPrintFilter: event?.filters,
                      },
                    },
                  }),
                );
                  ...
                  <div className="table_main_Wrapper bg-white mb-3">
                    ...
                    <div className="data_table_wrapper cell_padding_large is_filter custom_suggested_mfg">
                      ...
                      <DataTable
                        ...
                        filters={mfgLiveSemiROTOPrintingFilter}
                        onFilter={event => {
                          dispatch(
                            setAllCommon({
                              ...allCommon,
                              mfgLiveFlexo: {
                                ...
                                mfgLiveSemiROTOPrint: {
                                  ...allCommon?.mfgLiveFlexo
                                    .mfgLiveSemiROTOPrint,
                                  mfgLiveSemiROTOPrintingFilter: event?.filters,
                                },
                              },
                            }),
                          );
...
export default MFGLiveSemiRoto;
