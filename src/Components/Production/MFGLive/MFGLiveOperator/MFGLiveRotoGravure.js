...
export default function MFGLiveRotoGravure() {
  ...
  const { mfgListRotoParam, print_technology, machine, print } =
    allFilters?.mfgLiveFlexo;
  const { mfgLiveRotoGravure } = allCommon?.mfgLiveFlexo;
  const {
            ...
            dispatch(
              setAllCommon({
                ...
                mfgLiveFlexo: {
                  ...
                  mfgLiveRotoGravure: {
                    ...allCommon?.mfgLiveFlexo?.mfgLiveRotoGravure,
          ...
          mfgLiveFlexo: {
            ...
            mfgListRotoParam: {
              ...
              ...(updatedFilters?.length === 0 &&
                Object.keys(allFilters.mfgLiveFlexo?.mfgListRotoParam?.applied)
                  ?.length !== 0 && {
                  applied: {},
                }),
              filters: [...updatedFilters],
              selectedItemIndex:
                updatedFilters?.length === 0 &&
                allFilters.mfgLiveFlexo?.mfgListRotoParam?.selectedItemIndex !==
                  ''
                  ? ''
                  : allFilters.mfgLiveFlexo?.mfgListRotoParam
                      ?.selectedItemIndex,
      ...
      setAllFilters({
        ...
        mfgLiveFlexo: {
          ...
          mfgListRotoParam: {
            ...mfgListRotoParam,
            filters: [
              ...allFilters?.mfgLiveFlexo?.mfgListRotoParam?.filters,
              { filter: '', value: '' },
            ],
          },
        },
  ...
  }, [filters, dispatch, allFilters, mfgListRotoParam, searchQuery]);
      ...
      <div className="flexo_printing_wrap mb-3">
        <div className="table_main_Wrapper bg-white">
          <CommonHeader
            ...
            searchInnerSateName="mfgListRotoParam"
            op={op}
            dates={dates}
          ...
          <div className="data_table_wrapper with_colspan_head cell_padding_small is_filter break_header">
            ...
            <DataTable
              ...
              filters={mfgLiveRotoGravureFilter}
              onFilter={event => {
                dispatch(
                  setAllCommon({
                    ...allCommon,
                    mfgLiveFlexo: {
                      ...
                      mfgLiveRotoGravure: {
                        ...allCommon?.mfgLiveFlexo.mfgLiveRotoGravure,
                        mfgLiveRotoGravureFilter: event?.filters,
                      },
                    },
                  }),
                );
                  ...
                  <div className="table_main_Wrapper bg-white mb-3">
                    ...
                    <div className="data_table_wrapper cell_padding_large is_filter custom_suggested_mfg">
                      ...
                      <DataTable
                        ...
                        filters={mfgLiveRotoGravurePrintingFilter}
                        onFilter={event => {
                          dispatch(
                            setAllCommon({
                              ...allCommon,
                      ...
                      dispatch(
                        setAllCommon({
                          ...
                          mfgLiveFlexo: {
                            ...
                            mfgLiveRotoGravure: {
                              ...allCommon?.mfgLiveFlexo.mfgLiveRotoGravure,
                              mfgLiveRotoGravurePrintingFilter: event?.filters,
                            },
                          },
                        }),
                      );
