...
const sizeTemplate = rowData => {
  return (
    <>
      ...
      {/* <span className="d-block">{`${
        rowData?.height ? 'X H ' + rowData.height : ''
      }`}</span> */}
      <span className="d-block">{`${
        rowData?.length ? 'X L ' + rowData.length : ''
      }`}</span>
    </>
  );
};
...
export default function MFGLiveRToRPrinting(props) {
  ...
  const { mfgListRToRParam, print_technology, machine, print } =
    allFilters?.mfgLiveFlexo;
  const { mfgRtoRPrinting } = allCommon?.mfgLiveFlexo;
  ...
  //           // if (assignedRoll?.length > 0) {
  //           let rollId = [];
  //           assignedRoll?.map(x => rollId.push(x?._id));
  //           let newObj = {
  //             ...printingData,
  //             roll_printed: rollId,
  //             roll_printed_date: storePrintedRoll,
  //           };
            ...
            dispatch(
              setAllCommon({
                ...
                mfgLiveFlexo: {
                  ...
                  mfgRtoRPrinting: {
                    ...allCommon?.mfgLiveFlexo?.mfgRtoRPrinting,
  ...
  const onPageRowsChange = useCallback(
    ...
    [allFilters, dispatch, machine, mfgListRToRParam, print, print_technology],
  );
            ...
            onClick={async e => {
              ...
              dispatch(
                setprintingData({
                  ...
                  pending_bag: response.hasOwnProperty('pending_bag')
                    ? response?.pending_bag
                    : data?.quantity,
                }),
              );
          ...
          mfgLiveFlexo: {
            ...
            mfgListRToRParam: {
              ...
              ...(updatedFilters?.length === 0 &&
                Object.keys(allFilters.mfgLiveFlexo?.mfgListRToRParam?.applied)
                  ?.length !== 0 && {
                  applied: {},
                }),
              filters: [...updatedFilters],
              selectedItemIndex:
                updatedFilters?.length === 0 &&
                allFilters.mfgLiveFlexo?.mfgListRToRParam?.selectedItemIndex !==
                  ''
                  ? ''
                  : allFilters.mfgLiveFlexo?.mfgListRToRParam
                      ?.selectedItemIndex,
      ...
      setAllFilters({
        ...
        mfgLiveFlexo: {
          ...
          mfgListRToRParam: {
            ...mfgListRToRParam,
            filters: [
              ...allFilters?.mfgLiveFlexo?.mfgListRToRParam?.filters,
              { filter: '', value: '' },
            ],
          },
        },
  ...
  }, [filters, dispatch, allFilters, mfgListRToRParam, searchQuery]);
      ...
      <div className="flexo_printing_wrap screen_printing mb-3">
        ...
        <div className="table_main_Wrapper bg-white">
          <CommonHeader
            ...
            searchInnerSateName="mfgListRToRParam"
            op={op}
            dates={dates}
                ...
                dispatch(
                  setAllCommon({
                    ...
                    mfgLiveFlexo: {
                      ...
                      mfgRtoRPrinting: {
                        ...allCommon?.mfgLiveFlexo.mfgRtoRPrinting,
                        mfgRtoRPrintingFilter: event?.filters,
                      },
                    },
                  }),
                );
          ...
          <div className="printing_content_wrap">
                  ...
                  <div className="table_main_Wrapper bg-white mb-3">
                    ...
                    <div className="data_table_wrapper cell_padding_large is_filter custom_suggested_mfg">
                      ...
                      <DataTable
                        ...
                        filters={mfgRtoRPrintPrintingFilter}
                        onFilter={event => {
                          dispatch(
                            setAllCommon({
                              ...allCommon,
                              mfgLiveFlexo: {
                                ...
                                mfgRtoRPrinting: {
                                  ...allCommon?.mfgLiveFlexo.mfgRtoRPrinting,
                                  mfgRtoRPrintPrintingFilter: event?.filters,
                                },
                              },
                            }),
                          );
            ...
            <div className="final_print_table mt-3">
              <div className="table_main_Wrapper bg-white">
                ...
                <div className="data_table_wrapper with_colspan_head cell_padding_large is_filter custom_suggested_mfg">
                  <button
                    type="button"
                    className="table_filter_btn"
                    // onClick={() => setFilterToggle(!filterToggle)}
