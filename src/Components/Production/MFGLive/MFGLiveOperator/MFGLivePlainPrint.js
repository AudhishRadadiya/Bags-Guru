...
import { setAllFilters, setAllCommon } from 'Store/Reducers/Common';
...
export default function MFGLivePlainPrint() {
  ...
  const { mfgListPlainParam, print_technology, machine, print } =
    allFilters?.mfgLiveFlexo;
  const { mfgLivePlainPrint } = allCommon?.mfgLiveFlexo;
  const {
    tabelFilterToggle,
  ...
  const loadRequiredData = useCallback(() => {
    ...
    dispatch(
      getListFilter({
        module_name: 'mfg_operator_plain',
      }),
    );
  ...
  //       mfgProcessPrintingById?.final_roll_printed?.includes(x?._id),
  //     );
  //     dispatch(
  //       setprintingData({
  //         ...printingData,
  ...
  useEffect(() => {
    if (
      ...
      if (assignedRoll?.length > 0) {
        assignData = [...assignedRoll, ...assignData];
      }
            ...
            dispatch(
              setAllCommon({
                ...
                mfgLiveFlexo: {
                  ...
                  mfgLivePlainPrint: {
                    ...allCommon?.mfgLiveFlexo?.mfgLivePlainPrint,
          ...
          mfgLiveFlexo: {
            ...
            mfgListPlainParam: {
              ...
              ...(updatedFilters?.length === 0 &&
                Object.keys(allFilters.mfgLiveFlexo?.mfgListPlainParam?.applied)
                  ?.length !== 0 && {
                  applied: {},
                }),
              filters: [...updatedFilters],
      ...
      setAllFilters({
        ...
        mfgLiveFlexo: {
          ...
          mfgListPlainParam: {
            ...mfgListPlainParam,
            filters: [
              ...allFilters?.mfgLiveFlexo?.mfgListPlainParam?.filters,
              { filter: '', value: '' },
            ],
          },
        },
  ...
  }, [filters, dispatch, allFilters, mfgListPlainParam, searchQuery]);
      ...
      <div className="flexo_printing_wrap  mb-3">
        <div className="table_main_Wrapper bg-white">
          <CommonHeader
            ...
            searchInnerSateName="mfgListPlainParam"
            op={op}
            dates={dates}
            ...
            mfgListParam={mfgListPlainParam}
            applied={applied}
          />
          ...
          <div className="data_table_wrapper with_colspan_head cell_padding_small is_filter break_header">
            ...
            <DataTable
              ...
              ref={tableRef}
              filters={mfgLivePlainPrintFilter}
              onFilter={event => {
                dispatch(
                  setAllCommon({
                    ...allCommon,
                    mfgLiveFlexo: {
                      ...
                      mfgLivePlainPrint: {
                        ...allCommon?.mfgLiveFlexo.mfgLivePlainPrint,
                        mfgLivePlainPrintFilter: event?.filters,
                      },
                    },
                  }),
                );
                  ...
                  <div className="table_main_Wrapper bg-white mb-3">
                    ...
                    <div className="data_table_wrapper cell_padding_large is_filter custom_suggested_mfg">
                      ...
                      <DataTable
                        ...
                        filters={mfgLivePlainPrintingFilter}
                        onFilter={event => {
                          dispatch(
                            setAllCommon({
                              ...allCommon,
                              mfgLiveFlexo: {
                                ...
                                mfgLivePlainPrint: {
                                  ...allCommon?.mfgLiveFlexo.mfgLivePlainPrint,
                                  mfgLivePlainPrintingFilter: event?.filters,
                                },
                              },
                            }),
                          );
